...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/images/Промышленное остекление балконов/IMG_1862.jpg", width: 4032, height: 3024, alt: "Стеклянные конструкции Идеальный Дом" }],
  },
  twitter: { card: "summary_large_image", title: "Стеклянные конструкции | Идеальный Дом", description: "Проектирование, изготовление и монтаж изделий из стекла в СПб.", images: ["/images/Промышленное остекление балконов/IMG_1862.jpg"] },
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  ...
  return <html lang="ru"><body><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(organization) }} /><Header /><main>{children}</main><Footer /><CookieConsent /></body></html>;
}
